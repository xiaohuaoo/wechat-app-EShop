...
Page({
  ...
  selectAddress(res){
    ...
    console.log(array)
    wx.navigateTo({
      url: '../shop_order/shop_order?array='+array+'&productAll='+encodeURIComponent(productAll),
    })
  },
  ...
  onLoad: function (options) {
    ...
    const product = decodeURIComponent(options.productAll)
    var productAll = JSON.parse(product);
    console.log('address下的productAll', productAll);
